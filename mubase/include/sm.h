 ...
 */
 ...
 class StorageManager {
     ...
     * for it.
     */
    static int createObject(const char *dbName, const char *objectName);
     ...
     */
    static int getFirstBlockId(const char *dbName, const char *objectName);
	
	/**
     * Returns the id of the last (ending) block of an object.
     */
	static int getLastBlockId(const char *dbName,const char *objectName);
	...
	/**
     * Allocates the block with block-id blockId to the object at the end.
     */
	static void addBlock(const char *dbName, const char *objectName, int blockId);
    /**
